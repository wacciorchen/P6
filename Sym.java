...
class FnSym extends Sym {
	...
	private int totalSize_formal;
	private int totalSize_local;
	...
	public void setFormal(int size){
		this.totalSize_formal = size;
	}
	
	public int getFormal(){
		return this.totalSize_formal;
	}
	
	public void setLocal(int size){
		this.totalSize_local = size;
	}
